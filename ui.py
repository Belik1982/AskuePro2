...
TRANS = {
    ...
    *   **kde:** Показник "густини". Чим вище число, тим стабільніше навантаження в цій точці.
    ...
    # Інше
    "chat_head": "🤖 ШІ-Аналітик", 
    "chat_open_btn": "🤖 ШІ-Аналітик", # Тепер це текст на кнопці
    "ai_sets": "Налаштування ШІ", 
    "ai_key_err": "Введіть API ключ", 
    "ai_ready": "Готовий", 
    "ai_load_btn": "Завантажити контекст", 
    "ai_analyzing": "Аналізую...", 
    "ai_q_placeholder": "Запитайте про дані (напр: 'Коли був пік?')",
...
# --- НОВА ФУНКЦІЯ: ДОПОВІДНА ДЛЯ ШІ ---
def render_ai_onboarding():
    """Відображає підказку, як користуватися ШІ."""
    st.markdown("""
    <div style="background-color:rgba(0, 104, 201, 0.1); padding: 15px; border-radius: 8px; border-left: 5px solid #0068c9; margin-bottom: 15px;">
        <h4 style="margin-top:0; color:#0068c9;">🤖 Чим я можу допомогти?</h4>
        <p style="font-size: 0.9rem; margin-bottom: 5px;">Я проаналізував завантажені вами дані і готовий відповідати на питання. Я бачу споживання, генерацію та пікові навантаження.</p>
        <p style="font-weight: bold; font-size: 0.85rem;">Приклади запитань:</p>
        <ul style="font-size: 0.85rem; margin-bottom: 0;">
            <li><i>"В який день було максимальне споживання?"</i></li>
            <li><i>"Порівняй споживання в будні та вихідні."</i></li>
            <li><i>"Чи є аномальні сплески вночі?"</i></li>
            <li><i>"Яка сумарна генерація за весь період?"</i></li>
        </ul>
    </div>
